      ...
      <div className="grid grid-cols-1 lg:grid-cols-[50%_50%] min-h-screen">
        ...
        >
          <img
            ...
            className="absolute z-30 inset-0 h-full w-full object-cover"
          />
        </div>
        ...
        >
          <div className="flex flex-col px-10   z-30 py-20 bg-white">
            <h2 className="text-7xl text-[#E75023] font-bold mb-8">{formatHeading(heading)}</h2>

            <div className="text-[#3B4A54]  font-serif text-lg max-w-3xl leading-relaxed space-y-6">
          ...
          <div className="bg-[#E75023]  overflow-hidden">
            <div className="section-half-text-fill z-10">
              <svg
                version="1.1"
                id="Layer_1"
