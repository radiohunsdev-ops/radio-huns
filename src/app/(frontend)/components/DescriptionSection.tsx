...
export default function DescriptionSection({ heading, body }: DescriptionSectionProps) {
  ...
  return (
    <div className="max-w-8xl py-20  container mx-auto px-4 sm:px-5 md:px-6 lg:px-6 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[40%_60%] items-start gap-y-4 md:gap-y-6 lg:gap-y-0">
      <h1
      ...
      <div className="text-[#3B4A54] pb-10 font-serif text-xl max-w-4xl leading-relaxed ">
