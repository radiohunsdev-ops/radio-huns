...
function Input({ label, color }: { label: string; color: string }) {
  return (
    <div>
      <label className="font-semibold" style={{ color }}>
        {label}
      </label>
      <input
        type="text"
    ...
    <main className="min-h-screen font-serif flex flex-col bg-[#F6F1E7]">
      <div className="grid grid-cols-[40%_60%] min-h-[80vh]">
        <div className="flex flex-col">
          <div className="relative text-[#F6F1E7]" style={{ backgroundColor: primaryColor }}>
            <div className="px-15 py-10">
              <h1 className="font-serif text-[80px] leading-[1.05]">
                Get in
                <br />
        ...
        <div className="px-24 py-10">
          <form className="space-y-16">
            ...
            <div>
              <label className="font-semibold" style={{ color: primaryColor }}>
                Enter your message *
              </label>

              <textarea
                rows={3}
                className="w-full bg-transparent border-b border-gray-600 focus:outline-none py-2 resize-none"
              />
            </div>
      ...
      <div className="bg-[#F9B855] h-[20vh] grid grid-cols-[40%_60%]">
        ...
        <div className="relative">
          <div
            className="absolute left-0 bottom-0 h-[25vh] w-[90%] pt-10"
            style={{ backgroundColor: secondaryColor }}
          >
            <div className="text-[#F6F1E7] px-10" style={{ backgroundColor: primaryColor }}>
