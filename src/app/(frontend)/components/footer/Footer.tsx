        ...
        <div className="relative">
          ...
          >
            ...
            >
              ...
              {/* BOTTOM */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs md:text-sm mt-5">
                <div className="flex flex-wrap gap-4 md:gap-6 text-[#F9B855]">
                  ...
                  <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs md:text-sm">
                    <Link href="/terms-and-conditions" className="hover:opacity-70 transition">
                      Terms & Conditions
                    </Link>
